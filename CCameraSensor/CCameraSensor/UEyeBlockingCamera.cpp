...
namespace CCameraSensor {
    ...
    ////////////////////////////////////////////////////////////////////////////    
    bool UEyeBlockingCamera::read( std::vector<ImageWrapper::Image>& vImages ) {
        if( !m_bOpened ) { 
